...
Because this application installs itself as a permanent background system service, you must place the downloaded file in the exact folder where you want it to live forever before running the installer.
